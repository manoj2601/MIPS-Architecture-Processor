...
set_property PACKAGE_PIN V16 [get_ports {push}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {push}]
set_property PACKAGE_PIN W16 [get_ports {push2}]					
...
set_property PACKAGE_PIN R3 [get_ports {r1}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r1}]
set_property PACKAGE_PIN W2 [get_ports {r2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r2}]
set_property PACKAGE_PIN U1 [get_ports {r3}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r3}]
set_property PACKAGE_PIN T1 [get_ports {r4}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {r4}]
set_property PACKAGE_PIN R2 [get_ports {r5}]					
